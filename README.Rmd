...
[![pre-commit.ci status](https://results.pre-commit.ci/badge/github/Betthauser-Neuro-Lab/silaR/main.svg)](https://results.pre-commit.ci/latest/github/Betthauser-Neuro-Lab/silaR/main)
<!-- badges: end -->
...
Functions support working with decreasing biomarkers.
